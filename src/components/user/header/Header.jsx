        ...
        <>
            <section className={`${style.header} d-flex vh-100 justify-content-center align-items-center`}>
                <div className={`${style.text} w-50`}>
                    ...
                    <h1>Exclusive Collection <br /> in <span>Our Online</span> Store</h1>
                    ...
                    <div className='d-flex gap-4 align-items-center'>
                        <div className='text-box d-flex d-flex align-items-center gap-2'>
                ...
                <div className={`${style.img} ${style.hight} w-50 d-flex justify-content-center align-items-center`}>
                    <img src={mainImg} alt="" />
                </div>
            </section>
        </>
